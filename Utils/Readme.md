# MobileSwiftyTessactPI
Questo pod è un fork della versione 2.2.3 del pod SwiftyTesseract del repository CocoaPods, resosi necessario per effetturare lo strip dell'arhitettura arm64 su piattaforma Simulatore e consenitre così il rilascio con XCoce 12. 
